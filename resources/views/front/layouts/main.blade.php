...
<div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-start" href="index.html">
            ...
            <div class="sidebar-brand-text mx-3"><img src="/front/img/logo.png" alt=""></div>
        </a>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; Kodesign 2020 | Made with <i class="fas fa-heart fa-fw text-danger"></i> by <a target="_blank" href="http://kodesign.ir">KoDesign</a></span>
                </div>
            </div>
        </footer>
